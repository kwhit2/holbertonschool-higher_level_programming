#!/usr/bin/python3
""" Unittest for all Base classes methods """
import unittest
import json
import pep8
import os
...
class TestBase(unittest.TestCase):
    ...
    def test_pep8(self):
        """ pep8 Test """
        p8format = pep8.StyleGuide(quiet=True)
        result = p8format.check_files(['models/base.py'])
        self.assertEqual(result.total_errors, 0, "pep8: Error(s)")
    ...
    def test_create_rect(self):
        """ Test that creation of rectangle object with create()
            method works """
    ...
    def test_file_loads_from_square(self):
        """ Tests if file loads from square object """
        sq1 = Square(2, 2, 3)
        sq2 = Square(2, 2)
    ...
    def test_file_loads_from_rect(self):
        """ Tests if file loads from rectangle object """
        rect1 = Rectangle(1, 2, 3)
        rect2 = Rectangle(1, 2)
